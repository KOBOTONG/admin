...
if (isset($_POST['submit'])) {
    ...
    $tomo = $_POST['tomonth'];
    $toyer = $_POST['toyear'];
    $resultmy = $_POST['resultmy'];
    $status = $_POST['status'];



    $update_query = "UPDATE booking SET stmonth='$stmo',styear='$styer',tomonth='$tomo',
                 toyear='$toyer',resultmy='$resultmy',status='$status' WHERE nobook='$update_id'";
            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <form method="post" action="edit_booking.php?edit_form=<?php echo $id; ?>" enctype="multipart/form-data">
                        ...
                        <select name="resultmy" class="btn btn-success dropdown-toggle">
                            <option value="<?php echo $resultmy; ?>"><?php echo $resultmy; ?></option>
